const colors = {
  ...
  muted: '#B5A9D6',             // Muted text (subtitles, timestamps)
  border: '#2F1C52',            // Subtle border (darker shade of card)
  accent: '#D0BCFF',            // Accent elements if needed (e.g. icons or highlights)
};
